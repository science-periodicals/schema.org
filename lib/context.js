  ...
  return {
    "@context": [
      schemaOrgContext['@context'],
      {
        ...
        //additional terms
        "valueType":  { "@id": "ioterms:valueType", "@type": "@id" },
        "filePath":    "ioterms:filePath",

        "doi": "bibo:doi",
        "pmid": "bibo:pmid",

        "Abstract": { "@id": "ioterms:Abstract", "@type": "@id" },
        "abstract": "ioterms:abstract",
        "abstractBody": "ioterms:abstractBody",

        "hashAlgorithm": "nfo:hashAlgorithm",
        "hashValue": "nfo:hashValue",

        "Readme":   { "@id": "ioterms:Readme", "@type": "@id" },

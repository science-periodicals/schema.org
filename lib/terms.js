module.exports = function(){
  ...
  return {
    ...
    "defines": [
      ...
      {
        "@id": "ioterms:hasChecksum",
        "@type": "rdf:Property",
        "comment":"The checksum of the resource.",
        "label": "checksum",
        "range": "ioterms:Checksum",
      ...
      {
        "@id": "ioterms:abstractBody",
        "@type": "rdf:Property",
        "label": "abstract body",
        "comment":"The actual body of the abstract",
        "range": "xsd:string",
        "domain": "ioterms:Abstract",
        "status": "testing",
        "seeAlso": "http://en.wikipedia.org/wiki/Abstract_(summary)"
      },
